...
#define kServiceAppUrlScheme    @"naverloginpractice"

#define kConsumerKey            @"IUr2QsKeiyWAizIMaQXH"
#define kConsumerSecret         @"AWMG9aq667"
#define kServiceAppName         @"naverloginpractice"
